      ...
      <header className="hero">
        ...
        <div className="hero-actions">
          ...
          <div className="hero-add-row">
            <button className="btn sand-fade hero-add" onClick={() => setModalType("income")}>💰 {t("Income")}</button>
            <button className="btn sand-fade hero-add" onClick={() => setModalType("expense")}>💸 {t("Expense")}</button>
            <button className="btn sand-fade hero-add" onClick={() => setModalType("saving")}>🏦 {t("Saving")}</button>
            <button className="btn sand-fade hero-add" onClick={() => setModalType("investment")}>📈 {t("Investment")}</button>
          </div>
        </div>
      </header>
